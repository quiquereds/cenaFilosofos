 ...
 * @author quiqu
 */
public class filosofoIzquierdo extends Thread {
    ...
    public filosofoIzquierdo(palillo izq, palillo der, int id, JLabel gifFilosofo, JTextArea textArea, JLabel semaforoIzquierdo, JLabel semaforoDerecho, JLabel Conteo){
    ...
    public void run(){
        for(int i = 1; i <= 3; i++){
            ...
            reporte = "El filosofo " + id + " ha tomado el palillo izquierdo  \n";
            
            textArea.append(reporte);
            try {
                sleep(3000);
            } catch (InterruptedException ex) {
                Logger.getLogger(filosofoIzquierdo.class.getName()).log(Level.SEVERE, null, ex);
            }
